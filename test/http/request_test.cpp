...
TEST_CASE("[http/request]") {
  SECTION("valid & invalid parsing of a request from string") {
    /* not end with /r/n */
    std::string request_0_str = "GET /hello.html HTTP/1.1\r\n"
    ...
    std::string request_1_str = "User-Agent: Mozilla/4.0\r\n"
    ...
    std::string request_2_str = "PUNCH /hello.html HTTP/1.1\r\n"
                                "User-Agent: Mozilla/4.0\r\n"
                                "Host: www.tutorialspoint.com\r\n"
                                "Connection: Keep-Alive\r\n"
                                "\r\n";
    ...
    std::string request_3_str = "GET /hello.html HTTP/2.0\r\n"
                                "User-Agent: Mozilla/4.0\r\n"
                                "Host: www.tutorialspoint.com\r\n"
                                "Connection: Keep-Alive\r\n"
                                "\r\n";
    ...
    std::string request_4_str = "GET /hello.html HTTP/1.1\r\n"
                                "\r\n";
    ...
    std::string request_5_str = "HEAD /hello.html HTTP/1.1\r\n"
                                "User-Agent: Mozilla/4.0\r\n"
                                "Host: www.tutorialspoint.com\r\n"
                                "Connection: close\r\n"
                                "\r\n";
    ...
    std::string request_6_str = "GET /hello.html HTTP/1.1\r\n"
                                "User-Agent: Mozilla/4.0\r\n"
                                "Host: www.tutorialspoint.com\r\n"
                                "Connection: Keep-Alive\r\n"
                                "\r\n";
